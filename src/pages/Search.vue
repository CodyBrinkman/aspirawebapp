...
<template>
  <v-container fluid grid-list-xl>
    <v-layout>
      ...
      <v-flex md1>
        <v-icon color="green" @click="$router.push({ name: 'Search' })">search</v-icon>
      </v-flex>
      <v-flex md1>
        <v-icon color="green" @click="$router.push({ name: 'Home' })">home</v-icon>
      </v-flex>
    </v-layout>
    ...
    <v-layout row>
      ...
      <v-flex md2>
        <v-btn class="success btn-size" v-on:click="search(statementID)">Search</v-btn>
      </v-flex>
      <v-flex md2>
        <v-btn class="success btn-size" v-on:click="history(statementID)">History</v-btn>
      </v-flex>
    </v-layout>
    ...
    <!-- v-for="statement in statements" v-bind:key="statement" -->
          ...
          <br />
            <v-stepper alt-labels>
              <v-stepper-header>
                ...
                <v-divider></v-divider>
                <v-stepper-step step :complete="(phase == 'Processing') || (phase == 'Approved')" color="green">
                  Aspira
                  <small>Claim Sent To TPA</small>
                </v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step step :complete="(phase == 'Approved')" color="green">
                  TPA
